...
const App = () => {
  ...
  return (
    <>
      <div className="bg-orange-100 ">
        ...
        >
          <div className=" m-2 flex flex-col gap-y-2 ">
            <FeaturesBar runner={runner} handleChangeCat={handleChangeCat} currRef={currRef} cartCount={cartCount} debounceSearch={debounceSearch} />
              ...
              {content.map((e, i) => {
                return (
                  <div
                    ...
                    onClick={(e) => {
                      !popup ? e.stopPropagation() : undefined;
                      setpopup(content[i]);
                    }}
                  >
                    <img
                      src={e.image}
                      alt="img"
                      className="w-[100%] min-w-[140px] h-[40%] mb-3 rounded mx-auto"
                    />
                    ...
                    <div className="flex text-yellow-600  gap-1">
                      ...
                      {Number(e.rating.rate) -
                        Math.floor(Number(e.rating.rate))>0 && (
                        <IoIosStarHalf />
                      )}
      ...
      <Cart items ={runn} cartCount={cartCount}/>
      </div>
    </>
  );
};
